    ...
    <div className="container px-4 py-8 md:px-6 md:py-12 mt-16">
      <div className="max-w-2xl mx-auto">
        ...
        <Alert className="mb-6">
          ...
          <AlertDescription>
            The more details you provide, the higher the chances of finding your
            item. Adding a bounty can increase visibility.
          </AlertDescription>
        </Alert>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Offering a bounty can increase the chances of finding your
                  item
                </p>
              </div>
              ...
              {formData.enableBounty && (
                <div className="space-y-4">
                  ...
                  <Alert className="bg-muted">
                    ...
                    <AlertDescription>
                      The bounty will be held in escrow and only released when
                      you confirm item recovery.
                    </AlertDescription>
                  </Alert>
                </div>
              )}
